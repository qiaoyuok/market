...
CREATE TABLE `onethink_auth_group` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '用户组状态：为1正常，为0关闭,-1为删除',
...
INSERT INTO `onethink_auth_rule` VALUES ('23', 'admin', '1', 'Admin/User/changeStatus?method=forbidUser', '关闭会员', '1', '');
...
INSERT INTO `onethink_auth_rule` VALUES ('29', 'admin', '1', 'Admin/AuthManager/changeStatus?method=forbidGroup', '关闭', '1', '');
...
INSERT INTO `onethink_auth_rule` VALUES ('47', 'admin', '1', 'Admin/Addons/disable', '关闭', '1', '');
...
INSERT INTO `onethink_auth_rule` VALUES ('130', 'admin', '2', 'Admin/User/changeStatus?method=forbidUser', '关闭会员', '-1', '');
...
INSERT INTO `onethink_auth_rule` VALUES ('135', 'admin', '2', 'Admin/AuthManager/changeStatus?method=forbidGroup', '关闭', '-1', '');
...
INSERT INTO `onethink_auth_rule` VALUES ('154', 'admin', '2', 'Admin/Addons/disable', '关闭', '-1', '');
...
INSERT INTO `onethink_menu` VALUES ('23', '变更行为状态', '19', '0', 'User/setStatus', '0', '\"用户->用户行为\"中的启用,关闭和删除权限', '', '0');
INSERT INTO `onethink_menu` VALUES ('24', '关闭会员', '19', '0', 'User/changeStatus?method=forbidUser', '0', '\"用户->用户信息\"中的关闭', '', '0');
...
INSERT INTO `onethink_menu` VALUES ('29', '关闭', '27', '0', 'AuthManager/changeStatus?method=forbidGroup', '0', '关闭用户组', '', '0');
INSERT INTO `onethink_menu` VALUES ('30', '恢复', '27', '0', 'AuthManager/changeStatus?method=resumeGroup', '0', '恢复已关闭的用户组', '', '0');
...
INSERT INTO `onethink_menu` VALUES ('50', '关闭', '44', '0', 'Addons/disable', '0', '关闭插件', '', '0');
