...
class AdminController extends Controller {
     ...
     * @author 朱亚杰  <zhuyajie@topthink.net>
     */
    protected function forbid ( $model , $where = array() , $msg = array( 'success'=>'状态关闭成功！', 'error'=>'状态关闭失败！')){
        $data    =  array('status' => 0);
    ...
    protected function diyedit ( $model , $where = array() ,$data, $msg = array( 'success'=>'更新成功！', 'error'=>'更新失败！')) {
    ...
    public function setStatus($Model=CONTROLLER_NAME){
        ...
        switch ($status){
            case -1 :
                ...
                break;
            case 0  :
                $this->forbid($Model, $map, array('success'=>'关闭成功','error'=>'关闭失败'));
                break;
            case 1  :
    ...
    final public function getMenus($controller=CONTROLLER_NAME){
        ...
        // var_dump("url like '%{$controller}/".ACTION_NAME."%'");
