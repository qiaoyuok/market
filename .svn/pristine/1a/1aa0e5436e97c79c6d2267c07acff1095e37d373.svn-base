...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '',$business_id,$manager,$shop_id){
        return $this->model->register($username, $password, $email, $mobile,$business_id,$manager,$shop_id);
    }
