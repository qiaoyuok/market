...
<body>
        ...
        <div class="form-item">
            ...
            <div class="controls kind_controls">
                <div class="diy_kind_top">
                    <?php if($cates != null): ?><ul>
                            <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["cate_parent"]) == "0"): ?><li class="category" value="<?php echo ($vo["cate_id"]); ?>"><?php echo ($vo["cate_name"]); ?></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                <?php else: ?><li><a href="#">请先添加分类</a></li>
                        </ul><?php endif; ?>
                </div>
            </div>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Goods/add');?>');
