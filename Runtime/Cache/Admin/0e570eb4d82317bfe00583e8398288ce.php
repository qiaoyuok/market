...
<body>
    ...
    <div class="tools auth-botton">
        ...
        <a url="<?php echo U('changestatus',array('method'=>'forbidGroup'));?>" class="btn ajax-post" target-form="ids" >关闭</a>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('AuthManager/changeStatus?method=forbidGroup&id='.$vo['id']);?>" class="ajax-get">关闭</a>
				<?php else: ?>
