...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <p id="but" style="cursor: pointer;color: green;font-size: 22px;"><?php echo ($shopgoodsinfo["goods_name"]); ?></p>
                <input type="text" class="text input-large" style="display: none;" name="shopgoods_id" value="<?php echo ($shopgoodsinfo["shopgoods_id"]); ?>">
                <input type="text" class="text input-large" style="display: none;" name="shop_id" value="<?php echo ($shopgoodsinfo["shop_id"]); ?>">
                <input type="text" class="text input-large" style="display: none;" id="goods_id" name="goods_id" value="<?php echo ($shopgoodsinfo["goods_id"]); ?>">
                <input type="text" class="text input-large" style="display: none;" id="goods_name" name="goods_name" value="<?php echo ($shopgoodsinfo["goods_name"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">进货价</label>
            <div class="controls">
                <input type="text" class="text input-large" name="cost" value="<?php echo ($shopgoodsinfo["cost"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">销售价</label>
            <div class="controls">
                <input type="text" class="text input-large" name="cell_price" value="<?php echo ($shopgoodsinfo["cell_price"]); ?>">
            </div>
        </div>
        <div class="form-item">
