...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <?php if(($is_show) == "1"): ?><div class="form-item">
                ...
                <div>
                    <div class="radio_business_box">
                        ...
                        <div class="controls">
                            <?php if(!empty($businesslists)): ?><select name="bus_business_id" id="business_box_val">
                    ...
                    <div class="radio_shop_box">
                        <label class="item-label">所属加盟商</label>
                        <div class="controls">
                            <?php if(!empty($businesslists)): ?><select name="com_business_id" id="shop_box_val">
                                    <?php if(is_array($businesslists)): $i = 0; $__LIST__ = $businesslists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["business_id"]); ?>"><?php echo ($vo["business_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <?php else: ?>
                                <a href="<?php echo U('Business/add');?>">请先添加加盟商</a><?php endif; ?>
